...
def render() -> None:
    """Assets management page — table, filters, and inline detail panel."""
    try:
        from app.pages.assets_list_view import render_assets_page
    except ImportError:
        from pages.assets_list_view import render_assets_page  # type: ignore
    render_assets_page()
