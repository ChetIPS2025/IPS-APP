...
def _tt_render_grid_section(
    *,
    ...
    if not entries_df.empty and "id" in entries_df.columns:
        ...
        st.caption("Select rows for export, edit, or delete.")
    ...
    return _tt_render_simple_timesheet(
        today=today,
