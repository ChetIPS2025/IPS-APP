...
def _render_custom_timekeeping_table(
    ...
    *,
    ...
    with st.container(key="timekeeping_table_wrap"):
        ...
        with header_cols[3]:
            st.markdown(
                '<span class="timekeeping-list-days-band-marker" aria-hidden="true"></span>',
                unsafe_allow_html=True,
            )
        ...
        with header_cols[4]:
            st.markdown(
                '<span class="timekeeping-list-summary-band-marker" aria-hidden="true"></span>',
                unsafe_allow_html=True,
            )
        ...
        for row in filtered:
            ...
            with st.container(key=f"tk_row_{timecard_id}"):
                ...
                with row_cols[3]:
                    with st.container(key=f"tk_row_days_{timecard_id}"):
                        st.markdown(
                            '<span class="timekeeping-list-days-band-marker" '
                            'aria-hidden="true"></span>',
                            unsafe_allow_html=True,
                        )
                ...
                with row_cols[4]:
                    with st.container(key=f"tk_row_summary_{timecard_id}"):
                        st.markdown(
                            '<span class="timekeeping-list-summary-band-marker" '
                            'aria-hidden="true"></span>',
                            unsafe_allow_html=True,
                        )
