...
try:
    from app.pages.job_database_modern_ui import inject_modern_jobs_css, render_jobs_table as _render_modern_jobs_table
except ImportError:
    from pages.job_database_modern_ui import inject_modern_jobs_css, render_jobs_table as _render_modern_jobs_table  # type: ignore
from db import (
    fetch_by_match,
            ...
            with render_card():
                ...
                with _vm_ctrl:
                    st.radio(
                        ...
                        label_visibility="collapsed",
                        help="**Table** — click rows to expand details. **Cards** — tap Open on a job (better on tablet/phone).",
                    )
