...
try:
    ...
    from app.pages.modules._data import load_assets
    ...
    from pages.modules._data import load_assets  # type: ignore
...
def render() -> None:
    ...
    with act_r:
        ...
        st.button("+ New Asset", key="ast_new", type="primary", use_container_width=True)
    ...
    def _filters() -> None:
        ...
        with c4:
            st.selectbox("Status", ["All Statuses", *ASSET_STATUSES], key="ast_status", label_visibility="collapsed")
        with c5:
