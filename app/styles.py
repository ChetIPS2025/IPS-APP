...
def inject_assets_module_css() -> None:
    """Assets list custom table styling — prefer tab-scoped inject_assets_page_css."""
...
def inject_ops_dashboard_css() -> None:
    """Inject operations dashboard layout styles (delegates to ui module)."""
...
/* Page header utility styles live in app/ui/page_header_styles.py */
</style>
""",
        unsafe_allow_html=True,
    )
