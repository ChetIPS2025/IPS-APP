...
def inject_timekeeping_module_css() -> None:
    ...
    st.markdown(
        f"""
<style id="ips-timekeeping-module-v67">
...
.st-key-timekeeping_table_wrap [class*="st-key-tk_list_hour_spin_"] [data-testid="stVerticalBlock"]:has(.timekeeping-hour-spinner-marker),
