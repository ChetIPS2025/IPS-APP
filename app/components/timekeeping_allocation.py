...
ALLOC_LINE_COLS = [2.2, 0.55, 0.5, 0.45, 0.5, 0.95, 1.35]
ALLOC_LINE_COLS_PRIMARY = [2.2, 0.55, 0.5, 0.45, 0.5, 0.95, 1.35]
...
def _render_allocation_row_actions(
    *,
    ...
    if (
        ...
        submit_col, add_col, remove_col = st.columns(3, gap="small")
        with submit_col:
            if (
                row_editable
                and line_id
