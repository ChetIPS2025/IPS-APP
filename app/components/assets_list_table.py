...
(function () {{
  ...
  const openSel = wrapSel + " [data-asset-action='open'][data-asset-id]";
  ...
  if (!doc.ipsAssetsTableDocClick) {{
    ...
    doc.addEventListener("click", function (e) {{
      ...
      const link = t.closest("[data-asset-action='open'][data-asset-id]");
  ...
  if (!doc.ipsAssetsTableBindObserver) {{
    ...
    doc.ipsAssetsTableBindObserver.observe(doc.body, {{ childList: true, subtree: true }});
  }}
  try {{
