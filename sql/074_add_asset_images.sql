-- Asset image metadata (Supabase Storage bucket: asset-images).
--
-- Setup notes:
-- 1. Create a private Storage bucket named `asset-images` in Supabase.
...
comment on column public.assets.image_path is
    'Storage object path in asset-images bucket (e.g. asset-images/<id>/<file>).';
comment on column public.assets.image_url is
